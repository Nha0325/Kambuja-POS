...
const controller = require('../../controller/users/admin-manager.controller')
const locationController = require('../../controller/system/location.controller')
...
router.get("/locations/summary", locationController.getSummary)
router.route("/admins")
...
router.patch("/alerts/read-all", controller.markAllAlertsAsRead)
router.patch("/alerts/:id/read", controller.markAlertAsRead)
