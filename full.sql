...
-- Schema ftc_pos
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ftc_pos` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ftc_pos`;

-- -----------------------------------------------------
-- Table `ftc_pos`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`users` (
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`business_day`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`business_day` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`floors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`floors` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`tables`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`tables` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `tables_ibfk_1`
    ...
    REFERENCES `ftc_pos`.`floors` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;

-- -----------------------------------------------------
-- Table `ftc_pos`.`categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`categories` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`products` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_products_category`
    ...
    REFERENCES `ftc_pos`.`categories` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`invoices` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`invoice_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`invoice_items` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `invoice_items_ibfk_1`
    ...
    REFERENCES `ftc_pos`.`invoices` (`id`),
  CONSTRAINT `invoice_items_ibfk_2`
    FOREIGN KEY (`product_id`)
    REFERENCES `ftc_pos`.`products` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;

-- -----------------------------------------------------
-- Table `ftc_pos`.`business_sessions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`business_sessions` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`payments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`payments` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`payment_invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`payment_invoices` (
  ...
  CONSTRAINT `fk_pi_payment`
    ...
    REFERENCES `ftc_pos`.`payments` (`id`)
    ON DELETE CASCADE,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`receipt_print_logs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`receipt_print_logs` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `invoice_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`merge_preprint_logs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`merge_preprint_logs` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ftc_pos`.`settings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ftc_pos`.`settings` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `usd_to_khr` INT NOT NULL DEFAULT '4100',
  `show_exchange_rate` TINYINT(1) NOT NULL DEFAULT '1',
  `company_name` VARCHAR(150) NULL DEFAULT 'FTC POS',
