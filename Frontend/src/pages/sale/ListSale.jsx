    ...
    <>
      <div className="p-4">
        <div className="flex items-center justify-between mt-2">
          ...
          <Link to="/sale/pos" className="btn btn-sm btn-neutral">
            + New Sale
          </Link>
        </div>
            ...
            <thead className="text-xs text-slate-500 bg-gray-50">
              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan="11" className="text-center p-8 text-gray-400 font-medium">
                  ...
                  data?.map((item, idx) => {
                    ...
                    return (
                      <tr key={item?._id || idx} className="border-b border-gray-100 text-xs hover:bg-gray-50">
                        ...
                        <td className="px-2 text-gray-700 font-medium">{item.customer?.name || "-"}</td>
