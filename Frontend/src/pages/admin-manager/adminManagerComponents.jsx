...
export function StatusBadge({ status }) {
  ...
  return (
    <span className="inline-flex items-center gap-2 rounded-full border border-gray-300 bg-white px-3 py-1 text-xs font-bold uppercase tracking-[0.05em] text-gray-700">
