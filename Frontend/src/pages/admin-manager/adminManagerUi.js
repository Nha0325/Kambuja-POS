...
export const inputClass = "h-11 w-full rounded-xl border border-[#e5e7eb] dark:border-[#27272a] bg-[#ffffff] dark:bg-[#111113] px-4 text-sm text-[#020617] dark:text-[#f8fafc] outline-none transition-all placeholder:text-[#64748b] dark:placeholder:text-[#a1a1aa] focus:border-[#06b6d4] focus:ring-1 focus:ring-[#06b6d4]"
export const selectClass = inputClass
export const primaryButtonClass = "inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-[#06b6d4] px-5 text-sm font-semibold text-[#ffffff] transition-all hover:bg-[#06b6d4]/90 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
