  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-black">Customer</h1>
        <Link to="/customer/create" className="btn btn-sm btn-neutral">
          + Add Customer
        </Link>
      </div>
              ...
              {!isLoading &&
                data?.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="min-w-40 p-4 font-medium text-gray-900">{item.name || "-"}</td>
